...
def generate_for(char_data)
  prompt = <<~PROMPT
    ...
    - description: один связный параграф про description современной формы иероглифа / состав / история / образ / общий смысл формы
    - philosophy: один параграф про философский кайф/даосизм этого иероглифа
